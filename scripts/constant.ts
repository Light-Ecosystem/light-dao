export class Constants {
  ...
  static readonly GOMBOC_CONTROLLER = "GOMBOC_CONTROLLER";
  static readonly STAKING_HOPE_GOMBOC = "STAKING_HOPE_GOMBOC";
  static readonly POOL_GOMBOC = "POOL_GOMBOC";
  static readonly GOMBOC_MOCK1 = "GOMBOC_MOCK1";
  static readonly GOMBOC_MOCK2 = "GOMBOC_MOCK2";
  ...
  static readonly OWNERSHIP = "OWNERSHIP";
}