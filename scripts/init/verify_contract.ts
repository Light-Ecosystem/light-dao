...
async function main() {
  const veLightAddress = FileUtils.getContractAddress(
    "0x04d7D7ffa4ECFC3280ACF8508e9122dfD16e3A75"
  );
  await verifyContract("0x04d7D7ffa4ECFC3280ACF8508e9122dfD16e3A75", [
    "0xC0f5ee5C2e6E830d114BFAAecE310c7625C0EF00",
    "0xf3a2BD652E6d90B2f330c8450E2E85734336Eb54",
  ]);
  ...
  // const veLightAddress = FileUtils.getContractAddress("0x04d7D7ffa4ECFC3280ACF8508e9122dfD16e3A75");
